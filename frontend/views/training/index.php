    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <h3 class="card-title">Training Application List  &nbsp;    <?= Html::a('<i class="fa fa-plus-square"></i> New Training Request',['create'],['class' => 'add-objective btn btn-outline-info btn-sm']) ?></h3>
