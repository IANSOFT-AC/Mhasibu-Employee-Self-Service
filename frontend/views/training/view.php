        ...
        <div class="col-md-12">
            <div class="card-info">
                <div class="card-header">
                    <h3>Training Request Document </h3>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class=" row col-md-12">
                                <div class="col-md-6">
                                    ...
                                    <?= $form->field($model, 'Training_Need')->dropDownList($trainingNeeds,['prompt' => 'Select ...', 'readonly' => true, 'disabled' =>  true]) ?>
                                    <?= $form->field($model, 'Date_of_Application')->textInput(['readonly' => true, 'disabled' =>  true])?>
                                    ...
                                    <?= $form->field($model, 'Expected_Cost')->textInput(['type' => 'number','readonly' => true, 'disabled' =>  true]); ?>
