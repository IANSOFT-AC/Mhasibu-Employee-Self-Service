...
$this->title = 'Recruitment - Applicant Academic Qualifications';
?>
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">My Academic Qualifications.</h3>
         ...
         $.fn.dataTable.ext.errMode = 'throw';        
          ...
          $('#leaves').DataTable({
            ...
            columns: [
                ...
                { title: 'From_Date' ,data: 'From_Date'},
                { title: 'To_Date' ,data: 'To_Date'},
           ...
           language: {
                "zeroRecords": "No  Academic Qualifications to show."
            },
